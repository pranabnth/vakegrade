...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h3 onclick="receivePupils()"><a href="/ClassTeacher/GenerateCertificates">Zeugnisse drucken</a></h3>
    <div>
        <input type="checkbox" id="printAll" value="Alle Zeugnisse drucken">Alle Zeugnisse drucken</input>
